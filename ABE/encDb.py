...
#groupObj = PairingGroup('BN254') #TF19.py e CWDL17
...
def genTrap(strIn, pk_s, msk):
    ...
    SK = kpabks.keygen(msk, pk_s, policy, policyMatrix, deltas)
...
def main():
    ...
    numLines = [1, 5, 10, 100]#, 10, 50, 100, 1000, 10000]
    numCols = [1, 3, 5, 10, 30, 60]
